...
public class Turn180 extends SpeedAlterator {
    ...
    public Turn180(Supplier<Pose2d> poseSupplier) {
        ...
        SwerveChassisConstants.PoseControllers.rotationPID.enableContinuousInput(-0.5, 0.5);
    }
    ...
    public ChassisSpeeds alterSpeed(ChassisSpeeds speeds, boolean robotRelative) {
        double speed = SwerveChassisConstants.PoseControllers.rotationPID.calculate((poseSupplier.get().getRotation().getRotations()), targetAngle);
