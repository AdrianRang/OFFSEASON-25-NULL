...
public class SwerveModule extends SubsystemBase {
    ...
    public SwerveModuleState getRealState() {
        return new SwerveModuleState(
            this.driveMotor.getVelocity().getValueAsDouble() * 180 * Constants.SwerveChassisConstants.PhysicalModel.kDriveEncoder_RPMToMeterPerSecond,
    ...
    public SwerveModulePosition getPosition() {
        return new SwerveModulePosition(
            this.driveMotor.getPosition().getValueAsDouble() * 3 * Constants.SwerveChassisConstants.PhysicalModel.kDriveEncoder_RotationToMeter,
            Rotation2d.fromRotations(this.getAngle().in(Rotations))
        );
    }
