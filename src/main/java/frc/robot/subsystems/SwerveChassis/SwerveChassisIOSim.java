...
public class SwerveChassisIOSim implements SwerveChassisIO {
    ...
    public void setModuleStates(SwerveModuleState[] desiredStates) {
        SwerveDriveKinematics.desaturateWheelSpeeds(desiredStates, SwerveChassisConstants.PhysicalModel.kMaxSpeed.in(MetersPerSecond));
    ...
    public void drive(ChassisSpeeds speeds) {
        ...
        SwerveModuleState[] m_moduleStates = SwerveChassisConstants.PhysicalModel.kDriveKinematics.toSwerveModuleStates(speeds);
