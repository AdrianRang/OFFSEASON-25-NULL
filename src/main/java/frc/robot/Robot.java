...
public class Robot extends LoggedRobot {
  ...
  SignalLogger.enableAutoLogging(false);
    ...
    try {
      ...
      Elastic.sendNotification(new Notification(NotificationLevel.INFO, "DataLogManager started", "DataLogManager started successfully."));
    } catch (Exception e) {
      Elastic.sendNotification(new Notification(NotificationLevel.ERROR, "DataLogManager failed to start", "DataLogManager failed to start."));
    }
  ...
  public void testInit() {
    ...
    SimulatedArena.getInstance()
                .addGamePieceProjectile(ReefscapeCoralOnFly.DropFromCoralStation(
                        ReefscapeCoralOnFly.CoralStationsSide.LEFT_STATION, DriverStation.Alliance.Red, false));
  }
